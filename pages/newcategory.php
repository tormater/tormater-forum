...
if($_SERVER['REQUEST_METHOD'] != 'POST')
{
	...
	echo "<form method='post' action=''>
		<div class='forminput'>Category name: <input type='text' name='cat_name'></div>
		<div class='forminput'>Category description:</div>
		<div class='forminput'><textarea name='cat_description'></textarea></div>
		<div class='forminput'><input type='submit' class='buttonbig' value='Add category'></div>
 	</form>";
}
