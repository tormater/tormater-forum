...
$lang = array(
    ...
    "error.CategoryThreadMisc" => "موضوع‌های این دسته‌بندی نمایش داده نمی‌شوند.",
    ...
    "homepage.CatThreads" => "موضوع",
    "homepage.Threads" => "آخرین موضوع‌ها",
    "homepage.Cats" => "دسته بندی‌",
    "homepage.Title" => "صفحه اصلی",
    
    "category.ThreadsIn" => "موضوع ",
    "category.Thread" => "موضوع",
    "category.Posts" => "نوشته",
    ...
    "panel.CategoryDataWillGone" => "همه موضوع‌ها و نوشته‌های این دسته‌بندی برای همیشه از بین خواهند رفت...",
    ...
    "user.TitlePosts" => "نوشته:",
    "user.TitleThreads" => "موضوع:",
