...
$lang = array(
    ...
    "error.ExtensionWarning" => "این افزونه برای نسخه‌ی <i>%s</i> طراحی شده است، در حالی که نسخه‌ی انجمن شما <i>%s</i> است. بنابراین ممکن است به درستی کار نکند. لطفاً برای دریافت به‌روزرسانی به نویسنده‌ی افزونه مراجعه کنید.",
    "error.ThemeWarning" => "این پوسته برای نسخه‌ی <i>%s</i> طراحی شده است، در حالی که نسخه‌ی انجمن شما <i>%s</i> است. بنابراین ممکن است به درستی کار نکند. لطفاً برای دریافت به‌روزرسانی به نویسنده‌ی پوسته مراجعه کنید.",
    ...
    "nav.BadAction" => "شما مجوز انجام این عمل را ندارید.",
    "nav.BadActionLoginRequired" => "برای انجام این عمل باید <a href='%s'>وارد سیستم شوید</a>.",
    "nav.RateLimited" => "شما تحت محدودیت نرخ درخواست قرار دارید. لطفاً قبل از تلاش مجدد برای این عمل، اندکی صبر کنید.",
    "nav.FirstPage" => "<<",
    "nav.PrevPage" => "<",
    "nav.NextPage" => ">",
    "nav.LastPage" => ">>",
    ...
    "search.Submit" => "جستجو",
    "search.LabelLabel" => "همراه با برچسب(ها)",
    "userlist.sort.posts" => "تعداد پست‌ها",
