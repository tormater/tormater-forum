...
$lang = array(
    ...
    "error.UserlistMembersOnly" => "This forum is set so that only registered users can view the userlist. You're encouraged to <a href='/signup/'>signup</a> or <a href='/login/'>login</a> here so that you can see the userlist.",
