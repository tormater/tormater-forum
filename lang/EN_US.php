...
$lang = array(
    ...
    "thread.PostBig1" => "Your post was too long. The maximum number of characters a post may contain is currently set to ",
    "thread.PostBig2" => ".",
    ...
    // Error
    "newthread.LoginToCreate" => "Sorry, you have to be <a href='/login/'>logged in</a> to create a thread.",
    ...
    "panel.CantUpdateCategory" => "Sorry, can't update category.",
    "panel.SuccessUpdateCategory" => "Successfully update.",
    ...
    "panel.CantDeleteCategory" => "Sorry, can't delete category.",
    "panel.DeleteCategoryBtn" => "Delete it",
    "panel.DeleteCategoryBackBtn" => "Go back",
    "panel.SuccessDeleteCategory" => "Successfully delete.",
    "panel.NoNewCategoriesCreate" => "Sorry, no more new categories can be created at this time.",
    ...
    "register.EmailExists" => "This Email already exists.",
    "register.InvalidEmailFormat" => "Invalid Email format.",
    ...
    "register.ConfirmPasswordWrong" => "The confirm password is not the same.",
    ...
    // User page
    "user.FaildFindUser" => "Error! Failed to find given user!",
