...
$lang = array(
    ...
    "error.UsernameAlphNum" => "Your username may only contain alphanumeric characters.",
    "error.UsernameSmall" => "Your username must be at least 3 characters long.",
    "error.UsernameBig" => "Your username cannot be longer than 24 characters.",
    "register.UsernameExists" => "An account with this username already exists.",
    ...
    "register.PasswordSmall" => "Your password must be at least 6 characters long.",
    ...
    "register.TooManyAccounts" => "Too many accounts have been created from your IP address.",
    ...
    "register.EmailShort" => "Your email cannot be less than 1 character in length.",
    "register.EmailLong" => "Your email cannot be greater than 254 characters in length.",
    "register.Approval" => "Successfully registered. Your account must be approved before you can <a href='%s'>log in</a> and start posting. Come back and check in on your account later on.",
    "register.Closed" => "Sorry, account registration is currently disabled on this forum. Try coming back and checking in again later.",
